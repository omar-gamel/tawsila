...
router.route('/:clientId/addTofavorite')
    .post(
        jwtAuth.authenticate(),
        favoriteController.addToFavourite
    )

router.route('/:clientId/removefavorite')
    .post(
        jwtAuth.authenticate(),
        favoriteController.removeFromFavourite
    )
router.route('/:clientId/get-all-favorites')
    .get(
        jwtAuth.authenticate(),
        favoriteController.findAllClientFavourite
    )    
